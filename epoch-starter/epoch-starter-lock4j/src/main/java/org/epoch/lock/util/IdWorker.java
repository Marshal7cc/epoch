...
public class IdWorker {
     ...
     * 数据中心ID左移17位
     */
    private final static long DATACENTER_ID_SHIFT = SEQUENCE_BITS + MAX_WORKER_ID;
    /**
     * 时间毫秒左移22位
     */
    private final static long TIMESTAMP_LEFT_SHIFT = SEQUENCE_BITS + MAX_WORKER_ID + DATACENTER_ID_BITS;
