...
public class BaseMybatisRepository<R extends BaseMapper<T>, T, ID extends Serializable> extends ServiceImpl<R, T> implements BaseRepository<T, ID> {
    ...
    protected BaseMybatisRepository() {
        ...
        this.entityClass = (Class<T>) ReflectionKit.getSuperClassGenericType(this.getClass(), ServiceImpl.class, 0);
    }
