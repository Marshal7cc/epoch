package org.epoch.lock.autoconfigure;
...
public class LockConfigProperties {
    ...
    public static final String PREFIX = "epoch.lock";
     ...
     * 客户端名称
     */
    private String clientName = LockConstants.LOCK_CLIENT_NAME;
    /**
     * 启用SSL终端识别
     */
     ...
     */
    private String sslProvider = LockConstants.JDK;
    /**
     * SSL信任证书库路径
     */
