package com.marshal.epoch.database.service.impl;
...
import com.marshal.epoch.common.exception.ExcelException;
import com.marshal.epoch.database.service.BaseService;
import com.marshal.epoch.common.util.DtoUtil;
...
public class BaseServiceImpl<T> implements BaseService<T>, BaseConstant {
    ...
    public void excelImport(MultipartFile file, Class clazz) throws ExcelException {
        ...
        try {
            ...
            throw new ExcelException(BaseConstant.EXCEL_IMPORT_FAIL);
        }
    ...
    public void excelExport(HttpServletResponse response, List<T> records, Class clazz, String fileName) throws ExcelException {
        ...
        try {
            ...
            throw new ExcelException(BaseConstant.EXCEL_EXPORT_FAIL);
        }
    }
