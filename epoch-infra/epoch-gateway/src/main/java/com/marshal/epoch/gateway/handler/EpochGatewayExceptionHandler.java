package com.marshal.epoch.gateway.handler;
 ...
 */
@Slf4j
public class EpochGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    private static final String CONNECT_REFUSE = "connection refused";

    public EpochGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
    ...
    protected Map<String, Object> getErrorAttributes(ServerRequest request, boolean includeStackTrace) {
        ...
        } else if (StringUtils.containsIgnoreCase(error.getMessage(), CONNECT_REFUSE)) {
