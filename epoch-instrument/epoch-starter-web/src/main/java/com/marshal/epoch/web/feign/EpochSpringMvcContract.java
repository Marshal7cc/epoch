package com.marshal.epoch.web.feign;
...
/**
 * <p>解决feign不支持多层继承的问题</p>
 *
 * @author Marshal Yuan
 * @date 2020/5/31
 */
public class EpochSpringMvcContract extends SpringMvcContract implements BaseConstants {
    ...
    private Optional<String> processPathValue(final Class<?> clz) {
        ...
        if (classAnnotation != null) {
            ...
            if (synthesizeAnnotation.value().length > 0) {
                ...
                if (!pathValue.startsWith(Symbol.SLASH)) {
                    pathValue = Symbol.SLASH + pathValue;
                }
